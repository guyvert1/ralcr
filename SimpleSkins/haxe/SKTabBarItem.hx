...
class SKTabBarItem extends RCSkin {
	...
	public function new (label:String, linkage:String, colors:Array<Null<Int>>) {
		...
		normal.background.addChild ( new RCTextView (0, 72, 155, null, label, FontManager.getFormat("regular", {color:0xCCCCCC, align:"center"})) );
		...
		highlighted.background.addChild ( new RCTextView (0, 72, 155, null, label, FontManager.getFormat("regular", {color:0xFFFFFF, align:"center"})) );
